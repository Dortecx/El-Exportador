...
export async function run(
  ...
  if (!checkYtMusicAvailable()) {
    throw new Error(
      "ytmusicapi is not configured. Expected auth file at ~/.config/m3u-to-ytmusic/ytmusic_auth.json"
    );
  }
...
function printResults(tracks: Track[], result: Awaited<ReturnType<typeof convertWithYtMusic>>, verbose: boolean): void {
